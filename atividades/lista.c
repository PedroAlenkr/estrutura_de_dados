#include<stdlib.h>
#include<stdio.h>
//exercício sobre lista com adições no começo meio e fim da lista (aqui pode fura fila :D)
...
void somaPar()
{
    ...
    for(i=0; i<tam; i++)
    {
        if(aux->valor %2==0 && aux->valor>0) somaP+= aux->valor;
    }
    somaP*= somaP;

    printf("quadrado da soma de pares da lista: %d",somaP);
}
